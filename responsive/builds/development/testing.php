...
<body>
  <header id="intro">
    ...
    <nav id="nav">
      <div class="navbar">
        <div class="brand"><a href="#welcome">Robert <span>Means</span></a></div>
        <ul>
          <li><a class="icon info" href="#hotelinfo"><span>about</span></a></li>
          <li><a class="icon rooms" href="#rooms"><span>mission</span></a></li>
          <li><a class="icon dining" href="#dining"><span>projects</span></a></li>
